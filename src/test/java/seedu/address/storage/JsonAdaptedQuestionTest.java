...
public class JsonAdaptedQuestionTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedQuestion person = new JsonAdaptedQuestion(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedQuestion person = new JsonAdaptedQuestion(VALID_NAME, null, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedQuestion person = new JsonAdaptedQuestion(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedQuestion person = new JsonAdaptedQuestion(VALID_NAME, VALID_PHONE, VALID_EMAIL, null, VALID_TAGS);
